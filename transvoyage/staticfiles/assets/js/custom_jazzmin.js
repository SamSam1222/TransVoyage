...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (loginContainer) {
        ...
        if (window.innerWidth < 768) {
            ...
            videoSource.src = "/static/videos/y2mate.com - The Heavy Hitting Burger  Promo Video_1080p.mp4";  // Mobile video path
        } else {
            // Large screen: bigger screen (video for larger devices)
            videoSource.src = "/static/videos/y2mate.com - The Heavy Hitting Burger  Promo Video_1080p.mp4";  // Desktop video path
        }
