...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (loginContainer) {
        ...
        if (window.innerWidth < 768) {
            ...
            videoSource.src = "/staticfiles/videos/Logistics Intro Video.mp4";  // Mobile video path
        } else {
            // Large screen: bigger screen (video for larger devices)
            videoSource.src = "/staticfiles/videos/Logistics Intro Video.mp4";  // Desktop video path
        }
