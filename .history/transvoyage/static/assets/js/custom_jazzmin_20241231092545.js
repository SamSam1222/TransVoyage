...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (loginContainer) {
        ...
        if (window.innerWidth < 768) {
            ...
            videoSource.src = "/static/assets/videos/Logistics Intro Video.mp4";  // Mobile video path
        } else {
            // Large screen: bigger screen (video for larger devices)
            videoSource.src = "/static/assets/videos/Logistics Intro Video.mp4";  // Desktop video path
        }
